...
Copyright 2026 [Sveinbjörn Þórðarson](mailto:sveinbjorn@sveinbjorn.org)  
Copyright 2020 [Kristján Rúnarsson](mailto:krunars@gmail.com)
...
in the directory `src/skiptir/dictionaries` (filenames `hyph_is*.dic`)
